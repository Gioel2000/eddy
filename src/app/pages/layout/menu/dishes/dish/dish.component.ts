...
@Component({
  ...
  template: `
    <div
      class="group relative flex flex-col w-full transition ease-in-out duration-100 items-start justify-between ring-1 rounded-2xl bg-white dark:bg-[#1A1A1A] h-full max-h-[385px] pb-1"
      [ngClass]="{
        'ring-zinc-100/80 dark:ring-zinc-900/80': !dish().visible,
        'ring-zinc-300 dark:ring-zinc-800': dish().visible,
      }"
    >
      <div class="w-full">
