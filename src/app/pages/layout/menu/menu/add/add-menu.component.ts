                          ...
                          <tbody class="bg-zinc-50 dark:bg-zinc-800">
                            ...
                            <tr class="border-t border-zinc-300 dark:border-zinc-700">
                              <th
                                colspan="4"
                                scope="colgroup"
                                class="bg-zinc-100 dark:bg-zinc-900 py-2 pl-4 pr-3 text-left text-sm font-semibold text-zinc-900 dark:text-zinc-100 sm:pl-3"
                              >
                                {{ category.name }}
                              </th>
                              <th
                                colspan="1"
                                scope="colgroup"
                                class="flex flex-row items-center gap-x-1 bg-zinc-100 dark:bg-zinc-900 py-2 pl-4 pr-3 text-left text-sm font-semibold text-zinc-900 dark:text-zinc-100 sm:pl-3"
                              >
                                <a
