  ...
  >
    <div class="relative">
      ...
      <div [ngClass]="{ hidden: !dropdown.isOpen() }">
        <div
          class="absolute z-10 mt-2 w-56 rounded-[10px] max-h-64 overflow-y-auto bg-white dark:bg-zinc-800 shadow-lg ring-1 ring-zinc-200 dark:ring-zinc-700 focus:outline-none transition ease-out duration-200 animate-blurToClear200 left-0 origin-top-left sm:right-0 sm:origin-top-right"
          role="menu"
