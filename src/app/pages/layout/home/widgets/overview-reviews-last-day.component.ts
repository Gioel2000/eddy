  ...
  template: `
    ...
    <div class="flex flex-col">
      ...
      <div class="lg:col-span-4">
        ...
        <div class="mt-6">
          <div class="mt-6 space-y-5 divide-y divide-zinc-200 dark:divide-zinc-700 pb-10">
...
export class OverviewReviewsLastDayComponent {
  ...
  family = computed(() => {
    const reviews = this.store().data.filter((review) => review.clientsType[0].toLowerCase() === 'family');
  ...
  solo = computed(() => {
    const reviews = this.store().data.filter((review) => review.clientsType[0].toLowerCase() === 'solo');
  ...
  couple = computed(() => {
    const reviews = this.store().data.filter((review) => review.clientsType[0].toLowerCase() === 'couple');
  ...
  business = computed(() => {
    const reviews = this.store().data.filter((review) => review.clientsType[0].toLowerCase() === 'business');
  ...
  countries = computed(() => {
    const countries = this.store().data.map((review) => review.country);
