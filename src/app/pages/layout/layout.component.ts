                      ...
                      <a class="flex items-center gap-x-4 lg:gap-x-6">
                        <div class="relative w-full">
                          <div [ngClass]="{ hidden: !layout.isDropdownOpenSm() }">
                            <div
                              class="absolute bottom-12 z-10 mt-2 w-[271px] origin-bottom divide-y divide-zinc-300 dark:divide-zinc-700/80 rounded-lg bg-zinc-50 dark:bg-zinc-800 shadow-lg ring-1 ring-inset ring-zinc-300 dark:ring-zinc-700/80 focus:outline-none transition ease-out duration-200"
                              role="menu"
                            ...
                            >
                              <div class="px-4 py-3" role="none"></div>
                              <div class="py-2" role="none">
                                <a
                                  (click)="settings.openDialog(); layout.closeMenu()"
                                  class="block px-4 py-2 text-sm hover:bg-zinc-300 dark:hover:bg-zinc-700/80"
                                  role="menuitem"
                                  tabindex="-1"
                                  id="menu-item-0"
                                >
