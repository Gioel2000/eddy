            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              >
                ...
                <div class="min-w-0 flex-1 ml-2">
                  <div class="focus:outline-none">
                    ...
                    <p class="text-sm font-bold text-zinc-200 mb-2">{{ 'GOOGLE' | translate }}</p>
                    <div class="flex items-center xl:col-span-1">
                      ...
                      <p class="flex flex-row ml-1 font-semibold w-8 text-sm tabular-nums text-zinc-300">
                      ...
                      <p class="flex flex-row items-center ml-1 font-semibold text-sm tabular-nums text-zinc-500">
                    ...
                    <div class="flex items-center xl:col-span-1">
                      ...
                      <p class="ml-1 font-semibold text-sm w-8 tabular-nums text-zinc-300">
              ...
              >
                ...
                <div class="min-w-0 flex-1 ml-2">
                  <div class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    <p class="text-sm font-bold text-zinc-200 mb-2">{{ 'TRIPADVISOR' | translate }}</p>
                    <div class="flex items-center xl:col-span-1">
                      <div class="flex flex-row relative whitespace-nowrap">
                        <svg
                          class="fill-yellow-400"
              ...
              >
                ...
                <div class="min-w-0 flex-1 ml-2">
                  <div class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    <p class="text-sm font-bold text-zinc-200 mb-2">{{ 'THE_FORK' | translate }}</p>
                    <div class="flex items-center xl:col-span-1">
                      <div class="flex flex-row relative whitespace-nowrap">
                        <svg
                          class="fill-yellow-400"
