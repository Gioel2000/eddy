...
import { GoogleStep2Component } from '../../../step2/ui/google.component';
import { TripadvisorStep2Component } from '../../../step2/ui/tripadvisor.component';
import { TheForkStep2Component } from '../../../step2/ui/thefork.component';
import { NoChannelComponent } from '../../../step2/ui/no-channel.component';
...
@Component({
  ...
  template: `
    ...
    @switch (store.stateChannels()) { @case ('loading') {
...
export class Step2CompetitorDialog {
  ...
  constructor() {
    toObservable(this.dialog.isDialogOpen)
      ...
      .subscribe(() => this.store.retriveChannels());
