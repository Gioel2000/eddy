        ...
        <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          <a class="flex flex-row items-center cursor-pointer font-[Pacifico] text-3xl font-normal">
            <svg
              ...
              xml:space="preserve"
              class="text-transparent w-[4.2rem] h-[4.2rem]"
            >
              <path
                fill="currentColor"
                opacity="1.000000"
        ...
        <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
          <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <img
              ...
              width="2432"
              height="1442"
              class="w-[76rem] h-[45rem] rounded-xl object-cover object-top bg-black/5 dark:bg-white/5 shadow-2xl ring-1 ring-black/10 dark:ring-white/10"
            />
          </div>
        </div>
      </div>
